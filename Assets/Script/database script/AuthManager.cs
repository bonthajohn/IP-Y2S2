...
public class Progress
{
    ...
    public Progress()
    {
        ...
        {
            { "peppermintPuzzle", new Dictionary<string, object> { { "status", "not_played" }, { "playedTime", 0 }, { "bestTime", double.MaxValue } } },
            { "chocolateCounting", new Dictionary<string, object> { { "status", "not_played" }, { "playedTime", 0 }, { "bestTime", double.MaxValue } } },
            { "candyWrapperSpelling", new Dictionary<string, object> { { "status", "not_played" }, { "playedTime", 0 }, { "bestTime", double.MaxValue } } },
            { "jellybeanColorMatching", new Dictionary<string, object> { { "status", "not_played" }, { "playedTime", 0 }, { "bestTime", double.MaxValue } } }
        };
    }
